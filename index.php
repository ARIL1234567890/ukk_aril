...
<body class="login" style="background-image:url('assets/image/bg123.jpg'); background-size:cover;">
    ...
    <div class="login_wrapper">
        ...
        <section class="login_content">
            ...
            <div class="separator">
                ...
                <a href="index.php#signup" class="to_register"> Buat Akun </a>
                </p>
        ...
        <section class="login_content">
            ...
            <div class="separator">
                ...
                <a href="index.php#signin" class="to_register"> Login </a>
                </p>
