...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Mar 2024 pada 00.53
...
(5, 'timun emas', 'zulfairy', 'PT Balai Pustaka', 2011, 'berceritakan tentang seorang wanita perubaya yang ingin mempunyai anak', 'timun emas.pdf'),
(6, 'sejarah sepak bola', 'Dr. H. Emral, M. Pd', 'SUKABINA Press', 2010, 'berisikan tentang asal mula permainan sepak bola', 'SEJARAH SEPAKBOLA.pdf'),
(8, 'Karya Tulis Ilmiah', 'admi syarif', 'LEMBAGA PENELITIAN UNIVERSITAS LAMPUNG', 2011, 'berisikan informasi tentang sebuah karya ilmiah', 'BUKU PENULISAN KARYA ILMIAH .pdf');
...
(6, 5, 5, '2024-03-05', '2024-03-07', 'Pinjam'),
(7, 5, 6, '2024-03-05', '2024-03-06', 'Pinjam');
...
(1, 'aril', '$2y$10$WeVRuVqIto7HU/sD9t5F2O61TXtUGTHmgD.5r968WLax.lNUYSZuG', 'aril@gmail.com', 'Muh. aril', 'Kendari', 'peminjam'),
(3, 'admin', '$2y$10$heh5gWaUeGEwZcoSBCs5ceQwBsTxAa1WFC7lOG6mAQ5IfykLeb4r2', 'slkd@gmail.com', 'admin 1', 'kendari', ''),
(4, 'petugas', '$2y$10$3lxuW/Ro8a/69SBSLWFIq.Ez1UpirQKI2Zdchh0la1sSN4kE.W.0i', 'abbc@gmail.com', 'petugas1', 'kendari', 'petugas'),
(5, 'peminjam', '$2y$10$yZhuqIODmueHCa/bJ0epUuyr6/280qyVMQ3Oyx3EbXXGqRFVNa7yC', 'harry@gmail.com', 'peminjam1', 'kendari', 'peminjam');
...
--
ALTER TABLE `koleksipribadi`
  MODIFY `KoleksiID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
